            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (mergedOptions.browserWS) {
                        logger.info("Waiting... checking the wss server...", { session: session });
                    }
                    else {
                        logger.info('Waiting... checking the browser...', { session: session });
                    }
                ...
                case 2:
                    ...
                    client_1.onStateChange(function (state) { return __awaiter(_this, void 0, void 0, function () {
                        var device, ckeckVersion;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!(state === enum_1.SocketState.PAIRING)) return [3 /*break*/, 5];
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, (0, auth_1.isBeta)(page_1)];
                                case 2:
                                    ckeckVersion = _a.sent();
                                    if (!(ckeckVersion === false)) return [3 /*break*/, 4];
                                    return [4 /*yield*/, page_1.evaluate(function () { return __awaiter(_this, void 0, void 0, function () {
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0: return [4 /*yield*/, window.Store.Login.triggerCriticalSyncLogout()];
                                                    case 1:
                                                        _a.sent();
                                                        return [2 /*return*/];
                                                }
                ...
                case 6:
                    _a.sent();
                    return [4 /*yield*/, (0, browser_1.injectApi)(page_1)];
                case 7:
                    _a.sent();
