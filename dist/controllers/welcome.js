...
function logUpdateAvailable(current, latest) {
    // prettier-ignore
    var newVersionLog = "There is a new version of ".concat(chalk.bold("Venom"), " ").concat(chalk.gray(current), " \u279C  ").concat(chalk.bold.green(latest), "\n") +
        "Update your package by running:\n\n" +
        "".concat(chalk.bold('\>'), " ").concat(chalk.blueBright('npm update venom-pro'));
    logger_1.defaultLogger.info(boxen(newVersionLog, { padding: 1 }));
    logger_1.defaultLogger.info("For more info visit: ".concat(chalk.underline('https://github.com/orkestral/venom/blob/master/Update.md'), "\n"));
}
